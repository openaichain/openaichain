...
unlocked to sign the oaccoin-Qt.app bundle.
...
allowing somebody to distribute a oaccoin-Qt.app or oaccoin-qt-setup.exe with a valid
...
that the oaccoin-qt.exe file inside the installer had not been tampered with.
