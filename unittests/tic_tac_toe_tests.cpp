...
BOOST_AUTO_TEST_CASE( tic_tac_toe_game ) try {
   ...
   BOOST_CHECK_EXCEPTION(chain.push_action(N(tic.tac.toe), N(move), N(player1), mutable_variant_object()
         ...
         ("by", "player1")
         ("mvt", mvt)
      ), oac_assert_message_exception, oac_assert_message_starts_with("it's not your turn yet"));
   ...
   BOOST_CHECK_EXCEPTION(chain.push_action(N(tic.tac.toe), N(move), N(player2), mutable_variant_object()
         ...
         ("by", "player2")
         ("mvt", mvt)
      ), oac_assert_message_exception, oac_assert_message_starts_with("not a valid movement"));
   ...
   BOOST_CHECK_EXCEPTION(chain.push_action(N(tic.tac.toe), N(move), N(player2), mutable_variant_object()
         ...
         ("by", "player2")
         ("mvt", mvt)
      ), oac_assert_message_exception, oac_assert_message_starts_with("the game has ended"));
   ...
   BOOST_CHECK_EXCEPTION(chain.push_action(N(tic.tac.toe), N(move), N(player2), mutable_variant_object()
         ...
         ("by", "player2")
         ("mvt", mvt)
      ), oac_assert_message_exception, oac_assert_message_starts_with("game doesn't exists"));
