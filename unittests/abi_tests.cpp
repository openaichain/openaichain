...
#include <oac/abi_generator/abi_generator.hpp>
...
auto get_resolver(const abi_def& abi = abi_def())
{
   return [&abi](const account_name &name) -> optional<abi_serializer> {
      return abi_serializer(oac_contract_abi(abi));
   };
}
...
{ try {
   ...
   abi_serializer abis(oac_contract_abi(abi));
   abis.validate();
...
using namespace oac::unittests::config;

struct abi_gen_helper {

  abi_gen_helper() {}

  static bool is_abi_generation_exception(const oac::abi_generation_exception& e) { return true; };

  bool generate_abi(const char* source, const char* abi, bool opt_sfs=false) {

    std::string include_param = std::string("-I") + oaclib_path;
    std::string pfr_include_param = std::string("-I") + pfr_include_path;
    std::string boost_include_param = std::string("-I") + boost_include_path;
    std::string stdcpp_include_param = std::string("-I") + oaclib_path + "/libc++/upstream/include";
    std::string stdc_include_param = std::string("-I") + oaclib_path +  "/musl/upstream/include";
    ...
    bool res = runToolOnCodeWithArgs(new find_oac_abi_macro_action(contract, actions, ""), source,
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unknown_type, ""), oac::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(double_base, ""), oac::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unable_to_determine_index, ""), oac::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_type_different_namespace, ""), oac::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(bad_index_type, "{}"), oac::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(union_table, ""), oac::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_action_different_type, ""), oac::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
} FC_LOG_AND_RETHROW() }
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(abigen_vector_multidimension, ""), oac::abi_generation_exception, abi_gen_helper::is_abi_generation_exception );
...
BOOST_FIXTURE_TEST_CASE(abigen_oacabi_macro, abi_gen_helper)
{ try {

   const char* abigen_oacabi_macro = R"=====(
      ...
      struct hello : public oac::contract {
        public:
   ...
   const char* abigen_oacabi_macro_abi = R"=====(
   {
     "types": [],
     "structs": [{
         "name": "hi",
   ...
   BOOST_TEST( generate_abi(abigen_oacabi_macro, abigen_oacabi_macro_abi) == true );
...
{ try {
   ...
   auto abi = oac_contract_abi(fc::json::from_string(my_abi).as<abi_def>());
   ...
   const char *my_other = R"=====(
    {
      "publickey"     :  "OAC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
      "publickey_arr" :  ["OAC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","OAC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","OAC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV"],
      "asset"         : "100.0000 SYS",
      ...
      "keyweight": {"key":"OAC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},
      "keyweight_arr": [{"key":"OAC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},{"key":"OAC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"OAC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":100},{"key":"OAC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":200}],
...
{ try {
   ...
   auto abi = oac_contract_abi(fc::json::from_string(typedef_cycle_abi).as<abi_def>());
...
{ try {
   ...
   abi_serializer abis(oac_contract_abi(abi_def()));
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "auth" : {
        ...
        "keys" : [ {"key" : "OAC65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", "weight" : 57005},
                   {"key" : "OAC5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", "weight" : 57605} ],
   ...
   BOOST_TEST("OAC65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)updauth.auth.keys[0].key);
   BOOST_TEST(57005u == updauth.auth.keys[0].weight);
   BOOST_TEST("OAC5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)updauth.auth.keys[1].key);
...
{ try {
   ...
   BOOST_TEST("OAC65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newacct.owner.keys[0].key);
   BOOST_TEST(57005u == newacct.owner.keys[0].weight);
   BOOST_TEST("OAC5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newacct.owner.keys[1].key);
   ...
   BOOST_TEST("OAC65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im" == (std::string)newacct.active.keys[0].key);
   BOOST_TEST(57005u == newacct.active.keys[0].weight);
   BOOST_TEST("OAC5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf" == (std::string)newacct.active.keys[1].key);
...
{ try {
   ...
   abi_serializer abis(oac_contract_abi(v.as<abi_def>()));
...
{ try {
   ...
   auto abi = oac_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());
...
BOOST_AUTO_TEST_CASE(abi_account_name_in_oac_abi)
{ try {
   // inifinite loop in types
   const char* repeat_abi = R"=====(
   {
