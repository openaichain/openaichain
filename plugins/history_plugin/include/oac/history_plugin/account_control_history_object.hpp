...
CHAINBASE_SET_INDEX_TYPE( oac::account_control_history_object, oac::account_control_history_multi_index )

FC_REFLECT( oac::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
