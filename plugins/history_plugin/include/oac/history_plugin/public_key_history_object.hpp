...
CHAINBASE_SET_INDEX_TYPE( oac::public_key_history_object, oac::public_key_history_multi_index )

FC_REFLECT( oac::public_key_history_object, (public_key)(name)(permission) )
