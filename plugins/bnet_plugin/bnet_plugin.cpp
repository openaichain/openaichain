...
#include <oac/bnet_plugin/bnet_plugin.hpp>
...
using oac::public_key_type;
using oac::chain_id_type;
using oac::block_id_type;
using oac::block_timestamp_type;
using std::string;
using oac::sha256;
using oac::signed_block_ptr;
using oac::packed_transaction_ptr;
using std::vector;
