...
CHAINBASE_SET_INDEX_TYPE( oac::transaction_history_object, oac::transaction_history_multi_index )

FC_REFLECT( oac::transaction_history_object, (block_id)(transaction_id)(transaction_status) )
