...
namespace std {
   ...
   template<>
   struct hash<oac::chain::account_name>
   {
    size_t operator()( const oac::chain::account_name& name )const
    {
...
CHAINBASE_SET_INDEX_TYPE( oac::account_transaction_history_object, oac::account_transaction_history_multi_index )

FC_REFLECT( oac::account_transaction_history_object, (name)(transaction_id) )
