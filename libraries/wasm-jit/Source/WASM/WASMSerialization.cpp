#include "../../../chain/include/oac/chain/wasm_oac_constraints.hpp"
...
namespace WASM
{
	...
	void serializeFunctionBody(InputStream& sectionStream,Module& module,FunctionDef& functionDef)
	{
      ...
      constexpr size_t max_size = oac::chain::wasm_constraints::maximum_code_size;
	...
	void serializeImportSection(Stream& moduleStream,Module& module)
	{
		serializeSection(moduleStream,SectionType::import,[&module](Stream& sectionStream)
		{
         ...
         constexpr size_t max_size = oac::chain::wasm_constraints::maximum_section_elements;
			if(Stream::isInput)
			{
