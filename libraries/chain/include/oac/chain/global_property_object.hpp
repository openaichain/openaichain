...
#include <oac/chain/block_timestamp.hpp>
#include <oac/chain/chain_config.hpp>
#include <oac/chain/producer_schedule.hpp>
#include <oac/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(oac::chain::global_property_object, oac::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(oac::chain::dynamic_global_property_object,
                         oac::chain::dynamic_global_property_multi_index)

FC_REFLECT(oac::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(oac::chain::global_property_object,
