...
FC_REFLECT(oac::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(oac::chain::key_weight, (key)(weight) )
FC_REFLECT(oac::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(oac::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(oac::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
