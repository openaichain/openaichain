...
CHAINBASE_SET_INDEX_TYPE(oac::chain::permission_object, oac::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(oac::chain::permission_usage_object, oac::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<oac::chain::permission_object>, (_id))
FC_REFLECT(oac::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<oac::chain::permission_usage_object>, (_id))
FC_REFLECT(oac::chain::permission_usage_object, (id)(last_used))
