#pragma once
#include <oac/chain/block_header.hpp>
...
FC_REFLECT_ENUM( oac::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(oac::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(oac::chain::transaction_receipt, (oac::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(oac::chain::signed_block, (oac::chain::signed_block_header), (transactions)(block_extensions) )
