...
namespace oac { namespace chain {
    ...
    *  In the context of oac, every action is dispatched to the handler defined
...
FC_REFLECT( oac::chain::permission_level, (actor)(permission) )
FC_REFLECT( oac::chain::action, (account)(name)(authorization)(data) )
