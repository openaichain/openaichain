...
FC_REFLECT( oac::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( oac::chain::field_def                        , (name)(type) )
FC_REFLECT( oac::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( oac::chain::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( oac::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( oac::chain::clause_pair                      , (id)(body) )
FC_REFLECT( oac::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( oac::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
