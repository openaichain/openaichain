...
namespace oac { namespace chain {
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against OACIO specific constraints
      ...
      private:
         ...
         friend class oac::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( oac::chain::wasm_interface::vm_type, (wavm)(binaryen) )
