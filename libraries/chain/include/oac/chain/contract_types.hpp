...
using action_name    = oac::chain::action_name;
...
FC_REFLECT( oac::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( oac::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( oac::chain::setabi                           , (account)(abi) )
FC_REFLECT( oac::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( oac::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( oac::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( oac::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( oac::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( oac::chain::onerror                          , (sender_id)(sent_trx) )
