...
#include <oac/chain/webassembly/wavm.hpp>
#include <oac/chain/webassembly/binaryen.hpp>
...
using namespace fc;
using namespace oac::chain::webassembly;
using namespace IR;
...
#define _REGISTER_INJECTED_INTRINSIC(R, CLS, INFO)\
   BOOST_PP_CAT(BOOST_PP_OVERLOAD(_REGISTER_INTRINSIC, _UNWRAP_SEQ INFO) _EXPAND_ARGS(CLS, OACIO_INJECTED_MODULE_NAME, INFO), BOOST_PP_EMPTY())
