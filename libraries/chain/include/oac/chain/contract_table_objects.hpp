...
#include <oac/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(oac::chain::table_id_object, oac::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(oac::chain::key_value_object, oac::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(oac::chain::index64_object, oac::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(oac::chain::index128_object, oac::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(oac::chain::index256_object, oac::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(oac::chain::index_double_object, oac::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(oac::chain::index_long_double_object, oac::chain::index_long_double_index)

FC_REFLECT(oac::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(oac::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
