...
CHAINBASE_SET_INDEX_TYPE(oac::chain::permission_link_object, oac::chain::permission_link_index)

FC_REFLECT(oac::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
