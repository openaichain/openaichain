...
#include <oac/utilities/rand.hpp>
#include <oac/chain/genesis_state.hpp>
#include <oac/wallet_plugin/wallet.hpp>
...
{ try {
   ...
   constexpr auto key3 = "5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3"; // oac key
   ...
   // oac key is imported automatically when a wallet is created
