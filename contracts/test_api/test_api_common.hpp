...
#ifdef DISABLE_OACLIB_SERIALIZE
#include <oaclib/serialize.hpp>
#undef OACLIB_SERIALIZE
#define OACLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  OACLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   OACLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   OACLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   OACLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
