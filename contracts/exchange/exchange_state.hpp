...
namespace oac {
   ...
   struct margin_state {
      ...
      extended_asset unlend( double ishares ) {
         ...
         oac_assert( interest_shares >= 0, "underflow" );
         oac_assert( total_lendable.amount >= 0, "underflow" );

         return result;
      }

      OACLIB_SERIALIZE( margin_state, (total_lendable)(total_lent)(least_collateralized)(interest_shares) )
   };
   ...
   struct exchange_state {
      ...
      struct connector {
         ...
         OACLIB_SERIALIZE( connector, (balance)(weight)(peer_margin) )
      };
      ...
      OACLIB_SERIALIZE( exchange_state, (manager)(supply)(fee)(base)(quote) )
   };

   typedef oac::multi_index<N(markets), exchange_state> markets;
