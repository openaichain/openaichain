...
namespace tic_tac_toe {
   ...
   struct game {
      ...
      OACLIB_SERIALIZE( game, (challenger)(host)(turn)(winner)(board) )
   };
   ...
   struct create {
      ...
      OACLIB_SERIALIZE( create, (challenger)(host) )
   };
   ...
   struct restart {
      ...
      OACLIB_SERIALIZE( restart, (challenger)(host)(by) )
   };
   ...
   struct close {
      ...
      OACLIB_SERIALIZE( close, (challenger)(host) )
   };
   ...
   struct movement {
      ...
      OACLIB_SERIALIZE( movement, (row)(column) )
   };
   ...
   struct move {
      ...
      OACLIB_SERIALIZE( move, (challenger)(host)(by)(mvt) )
   };

   /**
    * @brief table definition, used to store existing games and their current state
    */
   typedef oac::multi_index< games_account, game> games;
}
/// @}
