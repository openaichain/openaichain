...
extern "C" {
    ...
    */
   void  oac_assert( uint32_t test, const char* msg );
    ...
    */
   void  oac_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    */
   void  oac_assert_code( uint32_t test, uint64_t code );
    ...
    */
   [[noreturn]] void  oac_exit( int32_t code );
