...
namespace oac {
   ...
   class optional {
      public:
         ...
         T&       operator*()      { oac_assert(_valid, "dereference of empty optional"); return ref(); }
         const T& operator*()const { oac_assert(_valid, "dereference of empty optional"); return ref(); }

         T*       operator->()
         {
            oac_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         friend inline oac::datastream<Stream>& operator>> (oac::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         template<typename Stream>
         friend inline oac::datastream<Stream>& operator<< (oac::datastream<Stream>& ds, const optional& op)
         {
