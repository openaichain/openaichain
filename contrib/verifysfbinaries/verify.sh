...
###   This script attempts to download the signature file SHA256SUMS.asc from oaccoin.org
...
WORKINGDIR="/tmp/oaccoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://oaccoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://oaccoin.org/bin/"
VERSIONPREFIX="oaccoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'oaccoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[oaccoin-]<version>-[rc[0-9]] (example: oaccoin-0.9.2-rc1)"
   echo "wget output:"
