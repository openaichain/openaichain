oaccoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/oaccoin/files/oaccoin/oaccoin-0.5.4/
...
http://gitorious.org/oaccoin/oaccoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix oaccoin-Qt notifications under Growl 1.3.
Increase required age of oaccoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxoaccoin properly when installing oaccoin-Qt over it. (Windows)
