oaccoin Core version 0.9.2.1 is now available from:

  https://oaccoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 OACC to 0.01 OACC
...
- Fix "Start oaccoin on system login"
