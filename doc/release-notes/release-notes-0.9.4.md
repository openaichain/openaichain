oaccoin Core version 0.9.4 is now available from:

  https://oaccoin.org/bin/0.9.4/
...
this update is incompatible with the oaccoin system and could lead to consensus
forks.

oaccoin Core released binaries from https://oaccoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~oaccoin/+archive/ubuntu/oaccoin
- A third-party or self-compiled oaccoin Core

upgrade to oaccoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
