oaccoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/oaccoin/files/oaccoin/oaccoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the oaccoin
...
New/changed settings (command-line or oaccoin.conf file)
--------------------------------------------------------
