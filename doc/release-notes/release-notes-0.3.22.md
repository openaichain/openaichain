Download URL: https://sourceforge.net/projects/oaccoin/files/oaccoin/oaccoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 OACC fee schedule (users still pay 0.01 OACC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #oaccoin00 - #oaccoin99
