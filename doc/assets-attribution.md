The following is a list of assets used in the oaccoin source and their proper attribution.
...
* License: MIT
* Site: [https://oaccointalk.org/index.php?topic=15276.0](https://oaccointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original oaccoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/oaccoin.icns, src/qt/res/src/oaccoin.svg,
	src/qt/res/src/oaccoin.ico, src/qt/res/src/oaccoin.png,
	src/qt/res/src/oaccoin_testnet.png, docs/oaccoin_logo_doxygen.png,
